...
AllVideosExtensions = [
    'MKV', 'AVI', 'MP4', 'M4V', 'MOV', 'MPEG', 'TS', 'M2TS', 'OGG', 'OGM',
    'H264', 'H265', 'WEBM', 'WMV',
]
...
GitHubRepoUrlTag = "<a href=\"https://github.com/dev-zetta/mkv-muxing-batch-gui\">Our Home Page</a> "
GPLV2UrlTag = "<a href=\"http://www.gnu.org/licenses/old-licenses/gpl-2.0.html\">GPLv2</a>"
GitHubIssuesUrlTag = "<a href=\"https://github.com/dev-zetta/mkv-muxing-batch-gui/issues\">issues page</a>"
